# Make_chrtM5() monthly hourly wage by occupations charts function
# May 27, 2021
...
Make_chrtM5 <- function(MYtitl,hrw,tow,sex,type,month1,month2,altTitl,interv) {
  q0 <- readRDS(paste0("rds/",TS[[5]]$STCno,".rds"))
  q0 <- filter(q0,HRW==hrw,TOW==tow,SEX==sex)
  ...
  if (type==1) {
    MYsubtitl=paste0(hrw,",",tow,",",sex,"\n",
      "Monthly, ",Fmth," to ",Lmth,", ",TS[[5]]$Seas)
