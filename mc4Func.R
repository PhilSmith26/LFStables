...
mc4UI <- function(id) {
  tabPanel(tags$b(tags$span(style="color:blue", HTML("Charts"))),
    ...
    fluidRow(column(12,
      ...
      selectInput(NS(id,"lfc"), tags$b(tags$span(style="color:blue;font-size:20px", 
        "Choose a labour force characteristic:")),choices=lfc401,width = "100%"))
    ),
    ...
    selectInput(NS(id,"noc"), tags$b(tags$span(style="color:blue;font-size:20px", 
      "Choose an occupational group:")),choices = noc401,width = "100%"),
    fluidRow(column(6,
