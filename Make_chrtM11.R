# LFS monthly duration of unemployment
# July 9, 2021
...
Make_chrtM11 <- function(MYtitl,Geo1,Sex1,Age1,type,month1,month2,
  altTitl,interv) {
  ...
  if (type==1) {
    MYsubtitl=paste0(Geo1,", ",Sex1,", ",Age1,"\nMonthly, ",
      Fmth," to ",Lmth,"\n",TS[[11]]$Seas)
